...
export class slots {
    ...
    slotBearbeiten() {
        ...
        cy.wait(1000)
        // Checking for a valid Name Notifications
        cy.get('[class="v-input pb-6 v-input--has-state v-input--is-focused theme--light v-text-field v-text-field--is-booted v-text-field--enclosed v-text-field--outlined error--text"]')
            .find('[class="v-text-field__details"]')
            .contains('Der Name muss gesetzt sein')
            .should('be.visible')
        ...
        */
        ...
        // // Remove Name by clicking "X"
        cy.log('Remove Name by clicking "X"')
    ...
    cy.get('tbody')
        ...
        cy.get('tbody')
            ...
            .should('have.text', ' Category'+String(l)+', Category'+String(b)+'  ')
        ...
        cy.get('tbody')
            .find('tr')
            .find('td:nth-child(5)').eq(0)
            .should('have.text', ' Category'+String(l)+ ', Category'+String(b)+' | initial: Category'+String(l)+' ')
